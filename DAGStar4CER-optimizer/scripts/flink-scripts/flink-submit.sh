...
JAR_PATH="SocketWindowWordCount.jar"
JAR_ARGS='{
  "allowNonRestoredState": true,
  "entryClass": "org.apache.flink.streaming.examples.socket.SocketWindowWordCount",
  "parallelism": 1,
  "programArgs": "--hostname host.docker.internal --port 9999"
}'

#Hostname
FLINK_HOSTNAME="192.168.1.200:8081"
JOB_EXEC_TIME="1000s"
...
upload_output=$(curl -X POST -H "Expect:" -F "jarfile=@$JAR_PATH" $FLINK_HOSTNAME/jars/upload | head -n 1 | cut -d $' ' -f2)
