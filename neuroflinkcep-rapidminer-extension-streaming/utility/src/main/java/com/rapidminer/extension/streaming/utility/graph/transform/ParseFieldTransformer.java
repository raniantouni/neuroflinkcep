...
/**
 * Representation of the parse operation for fields.
 * This allows fields in a document to be replaced by their parsed equivalent.
 * <br/>
 * Let's say in the following document we want to replace the string value of "estimation" with its JSON equivalent:
 * <br/>
 * <b>from</b>:
 * <ul>
 ...
 * @since 0.1.0
 */
public class ParseFieldTransformer extends Transformer {
	...
	ParseFieldTransformer() {
		super(-1);
	}

	ParseFieldTransformer(Builder builder) {
	...
	public static class Builder {
		...
		public ParseFieldTransformer build() {
			ParseFieldTransformer node = new ParseFieldTransformer(this);
			if (node.parent != null) {
