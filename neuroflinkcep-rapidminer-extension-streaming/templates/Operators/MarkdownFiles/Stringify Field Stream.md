...
Operator Key: streaming:stringify_field

Group: transformations

## Description

This operator performs a stringify operation on the value of the specified fields of streamed data events in a streaming analytic workflow.

The value of the specified *keys* are parsed to strings.
...
#### Tutorial 1 (Simple Stringify Field Stream)

In this tutorial process the usage of the Stringify Field Stream operator is demonstrated.
    ...
    <process expanded="true">
      ...
      <operator activated="true" class="streaming:streaming_nest" compatibility="0.1.000-SNAPSHOT" expanded="true" height="82" name="Streaming Nest" width="90" x="380" y="34">
        ...
        <process expanded="true">
          ...
          <operator activated="true" class="streaming:stringify_field" compatibility="0.1.000-SNAPSHOT" expanded="true" height="68" name="Stringify Field Stream" width="90" x="581" y="136">
            <enumeration key="keys">
              <parameter key="key" value="test"/>
            </enumeration>
            <description align="center" color="transparent" colored="false" width="126">Stringify the value of the test field</description>
          </operator>
          ...
          <connect from_op="Kafka Source" from_port="output stream" to_op="Stringify Field Stream" to_port="input stream"/>
          <connect from_op="Stringify Field Stream" from_port="output stream" to_op="Kafka Sink" to_port="input stream"/>
...
Specify which keys shall be stringified in the data events.
