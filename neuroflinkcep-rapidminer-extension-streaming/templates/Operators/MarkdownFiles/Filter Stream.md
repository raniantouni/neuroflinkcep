...
#### Tutorial 1 (Simple Filter Stream)
...
- **Equal to**: The value in the *key* field of the data event needs to be equal to the *value*.

- **Not Equal to**: The value in the *key* field of the data event needs to be not equal to the *value*.

- **Greater than**: The value in the *key* field of the data event needs to be greater than to the *value*.

- **Greater than or equal to**: The value in the *key* field of the data event needs to be greater than or equal to the *value*.

- **Less than**: The value in the *key* field of the data event needs to be less than to the *value*.

- **Less than or equal to**: The value in the *key* field of the data event needs to be less than or equal to the *value*.
