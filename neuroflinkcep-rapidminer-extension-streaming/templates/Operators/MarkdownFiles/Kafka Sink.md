...
Operator Key: streaming:kafka_sink

Group: input_output

## Description

This operator provides a Kafka topic as a sink for a streaming analytic workflow.
...
#### Tutorial 1 (Simple Kafka Sink)

In this tutorial process the usage of the Kafka Sink operator is demonstrated.
      ...
      <operator activated="true" class="streaming:streaming_nest" compatibility="0.1.000-SNAPSHOT" expanded="true" height="82" name="Streaming Nest" origin="GENERATED_TUTORIAL" width="90" x="380" y="34">
        ...
        <process expanded="true">
          ...
          <operator activated="true" class="streaming:kafka_sink" compatibility="0.1.000-SNAPSHOT" expanded="true" height="82" name="Kafka Sink" origin="GENERATED_TUTORIAL" width="90" x="849" y="34">
            ...
            <description align="center" color="blue" colored="true" width="126">Use the Kafka Sink operator to push events to an output topic</description>
          </operator>
...
Kafka topic which is used as a sink.

#### record key

Name of the field to use for record key.
...
The connection to the Kafka Cluster which topic should be sinked.
